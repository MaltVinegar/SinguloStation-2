...
/obj/item/twohanded/required/chainsaw
	...
	var/icon_state_prefix = "chainsaw_"
	...
	var/onsound
	var/offsound
	onsound = 'sound/weapons/chainsawhit.ogg'
	offsound = "swing_hit"
	sharpness = IS_SHARP
...
/obj/item/twohanded/required/chainsaw/attack_self(mob/user)
	...
	icon_state = "[icon_state_prefix][on ? "on" : "off"]"
...
/obj/item/twohanded/required/chainsaw/proc/toggle_message(mob/user)
	to_chat(user, "As you pull the starting cord dangling from [src], [on ? "it begins to whirr." : "the chain stops moving."]")

/obj/item/twohanded/required/chainsaw/dropped(mob/user)
	..()
	on = FALSE
	force = initial(force)
	throwforce = initial(throwforce)
	icon_state = "[icon_state_prefix]off"
	hitsound = offsound
...
/obj/item/twohanded/required/chainsaw/energy
	...
	hitsound = 'sound/weapons/echainsawoff.ogg'
	onsound = 'sound/weapons/echainsawon.ogg'
	offsound = 'sound/weapons/echainsawoff.ogg'
	on = FALSE
	var/brightness_on = 3

/obj/item/twohanded/required/chainsaw/energy/toggle_message(mob/user)
